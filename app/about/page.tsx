...
export default function Page() {
  return (
    <div className=" p-32 text-lg font-mono">
      I created the ShopCart store template to showcase my expertise in
      full-stack technologies including Nextjs, Typescript, React, Tailwindcss,
      Nodejs,stripe, and MongoDb among others. This portfolio project is a
